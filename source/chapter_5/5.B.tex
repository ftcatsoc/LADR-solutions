...
令\(U=\altspan(u)\)，考虑商空间\(V/U\)，\(\dim V/U=n-1\)，因此可以对其使用假设.

构造\(T\)在\(V/U\)上的诱导变换\(T/U\)满足\(\forall v+U \in V/U,(T/U)(v+U)=Tv+U\).

则\(V/U\)存在一组基\(v_1+U,\cdots,v_n+U\)满足\((T/U)(v_i+U) \in \altspan(v_1+U,\cdots,v_n+U)\).
...
且满足\(\forall i=1,\cdots,n,Tv_i \in \altspan(u,v_1,\cdots,v_i)\).
