...
\begin{proof}[证明a]
    ...
    后面的证明与\probref{3.E.8}一致，注意到\(\lambda_1=1-\sum_{i=2}^m \lambda_i\)即可.
\end{proof}
...
\begin{proof}[证明c]
    ...
    根据\probref{3.E.13}，\(U \subseteq \ker T\).因此对于\(\forall T \in \operatorname{Im} \Gamma\)，有\(\forall u \in U,Tu=0\).    
\end{proof}
