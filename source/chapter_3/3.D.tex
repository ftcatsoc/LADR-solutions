...
根据\textit{3.D.5}，\(\Img S^{-1}T_1=\Img T_2\).
    \begin{align*}
        \dim \Ker T_1 &=\dim \Ker T_2R=\dim V-\dim \Img T_2R \\
        &=\dim V-\dim \Img T_2=\dim \Ker T_2
    \end{align*}
...
根据\textit{3.A.4}，\(v_1,\cdots,v_m\)线性无关.令\(U=\altspan (v_1,\cdots,v_m)\).
...
(\textit{b})证明：对于任意非零多项式\(p \in P(R)\)都有\(\altdeg Tp=\altdeg p\).
