...
现在考虑\((S^{-1}TS-\lambda I)^{\dim V}\).根据\textit{5.B.5}，
    \begin{align*}
...
\((S^{-1}(T-\lambda I)^{\dim V}S)(S^{-1}v)=S((T-\lambda I)^{\dim V}v)=0\).
...
\textit{11.}
设\(V\)满足\(\dim V=n\)是有限维复向量空间且\(T \in L(V)\)，\(\lambda_1,\cdots,\lambda_m\)是其所有相异特征值.
