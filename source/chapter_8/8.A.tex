...
\textit{3.}
设\(T \in L(V)\)是可逆变换且\(\mydim V=n\).证明：\(\forall \lambda \ne 0,G(\lambda,T)=G(\lambda^{-1},T^{-1})\).
...
再假设\(n-1\)的情况成立，考虑\(n\)的情况.令\(u=(T-\lambda)v=(T^{-1}-\lambda^{-1} I)v\).
    \begin{align*}
        ...
        &(T^{-1}-\lambda^{-1} I)^n v=(T^{-1}-\lambda^{-1} I)^{n-1}(T^{-1}-\lambda^{-1} I)v=(T^{-1}-\lambda^{-1} I)^{n-1}u=0
    \end{align*}
...
\textit{5.}
设\(T \in L(V),v \in V,m \in N^*\)，且\(T^{m-1}v \ne 0,T^m v=0\).求证：\(v,Tv,\cdots,T^{m-1}v\)线性无关.
