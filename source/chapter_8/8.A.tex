...
\begin{proof}
    根据\probref{8.A.16}，\(\forall i \in N^*,\operatorname{Im} T^{m+i} \subseteq \operatorname{Im} T^m\).
...
\begin{proof}
    ...
    根据习题2.C.1和\probref{8.A.16}，\(\forall i \in N^*,\operatorname{Im} T^{i+1}=\operatorname{Im} T^i\).
