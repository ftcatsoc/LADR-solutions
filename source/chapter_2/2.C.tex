...
下证\(1^{\circ}\altspan (p_0,p_1,\cdots,p_m,p_{m+1}) \subseteq \altspan (1,x,\cdots,x^m,x^{m+1})\)

并且\(2^{\circ}\altspan (1,x,\cdots,x^m,x^{m+1}) \subseteq \altspan (p_0,p_1,\cdots,p_m,p_{m+1})\).

\(1^{\circ}\)的证明是显然的.\(\forall p\in \altspan (p_0,p_1,\cdots,p_m,p_{m+1}),p\in P_{m+1}(F)\).
